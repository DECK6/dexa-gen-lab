...
- [x] **W6 배포** — source `0e5d49d` · adxdeck `gen/` `6d5172b` · Pages `30728825367` 성공 · 라이브 500/500 확인 (2026-08-02)
...
- **W6 라이브 검증**: 배포 HTML이 로컬 `dist/index.html`과 SHA-256 `d801ee86…`로 일치했고 썸네일 HTTP 500/500, 갤러리 카드 500개·카운터 `500 / 500`, ABOUT 500 문구, CA25 비블랭크·시간 변화, TX02 비블랭크를 확인했다. 콘솔·페이지·요청 오류는 0건. 후속 GLSL 배포 `47d2c4b`는 `gen/` 변경 0건으로 확인 (2026-08-02).
